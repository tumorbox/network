...
public class ClientChatView extends JFrame {
	...
	// 7-2. 채팅하는 사용자들의 목록을 JList에 추가(nickname)하기 위한 변수
	...
	// 7-9. 서버가 보내오는 데이터를 분석해서 처리하는 메소드를 정의
	private void filteringMsg(String msg) {
		...
		// 7-e-4. 서버가 전송한 메시지가 기존 클라이언트를 새로운 클라이언트에게 안내하는 경우
		}else {
